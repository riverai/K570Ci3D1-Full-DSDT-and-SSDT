 ...
 *
 * Disassembly of DSDT.aml, Thu Oct 29 16:28:48 2015
 *
    ...
    Scope (_SB)
    {
        ...
        Device (BAT0)
        {
            ...
            Method (UPBI, 0, NotSerialized)
            {
                ...
                Store (B1B2(^^PCI0.LPCB.EC0.SVG0,^^PCI0.LPCB.EC0.SVG0), Index (PBIF, 0x04))
